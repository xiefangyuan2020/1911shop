...
<center>
  <h2>文章分类
    ...
    <form class="form-horizontal" role="form" method="post" action="{{'/article/store'}}" enctype="multipart/form-data">
       @csrf
    <div class="form-group">
      <label for="firstname" class="col-sm-2 control-label">文章标题</label>
      <div class="col-sm-10">
        <input type="text" class="form-control" name="article_name" id="firstname" placeholder="请输入文章标题">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="radio" name="is_sing" value="1" checked>普通
      <input type="radio" name="is_sing" value="2">顶置
   ...
   <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" name="article_man" id="lastname">
     ...
     <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" name="article_email" id="lastname">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" name="article_word" id="lastname">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-10">
      <textarea type="text" name="article_content" class="form-control" id="lastname"></textarea>
    </div>
  </div>
    <div class="form-group">
